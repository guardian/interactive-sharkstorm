...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      css: {
        files: ['src/css/**/*.*'],
        tasks: ['sass', 'autoprefixer','replace:css'],
        options: {
          spawn: false,
        },
      }
    ...
    curl: {
      'src/js/app/data/sampleData.json': 'http://interactive.guim.co.uk/' + 
          'spreadsheetdata/1MmuJlli8VE4eEVgv94NHCTIrgIVE3UGJt2sJ8YJCeFg.json'
    }
  });
